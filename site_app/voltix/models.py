...
#     id = models.AutoField(primary_key=True)
#     user = models.ForeignKey(User, on_delete=models.CASCADE)
#     measurement_start = models.DateTimeField(null=True, blank=True)
#     measurement_end = models.DateTimeField(null=True, blank=True)
#     data = models.JSONField()
#     created_at = models.DateTimeField(auto_now_add=True)
#     updated_at = models.DateTimeField(auto_now=True)

#     def __str__(self):
#         return f"Measurement {self.id} - User: {self.user.fullname}"
...
#     def __str__(self):
#         return f"Comparison {self.id} - User: {self.user.fullname}"
